    ...
    <table class="w-full whitespace-no-wrap">
        ...
        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
            ...
            <tr class="text-gray-700 dark:text-gray-400" wire:key="">
                ...
                <td class="px-4 py-3 text-sm">{{ \App\Models\Option::where('student_id', $eval->student_id)->where('quarter', $eval->quarter)->where('academic_year', $eval->academic_year)->first()->created_at->diffForHumans() }}</td>
                <td class="px-4 py-3">
