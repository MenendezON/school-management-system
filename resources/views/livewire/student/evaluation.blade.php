<div class="container-fluid px-6 mx-auto grid">
    ...
    <div class="flex gap-2 justify-between">
        <h2 class="flex my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
            <x-nav-link href="{{ route('survey-eval-index', ['id' => $survey]) }}" class="bg-blue-500 pt-2 py-2 px-2 mr-2 rounded text-white" wire:navigate>
        ...
        <div class="flex mx-6 gap-4">
            <button wire:click="generateDoc" title="Télécharger">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="20" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
